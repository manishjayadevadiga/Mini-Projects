...
void introScreen()
{
	glClear(GL_COLOR_BUFFER_BIT);
		...
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-425, 490, 0.0,"SMVITM,BANTAKAL,UDUPI");
	...
	displayRasterText(-125, 225, 0.0,"Space Shooter");
	  ...
	  displayRasterText(-800, -100, 0.0," STUDENT NAMES");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0," Karthik H Amin (4MW19CS046)");
	displayRasterText(-800, -285, 0.0," Manish Kumar H.J (4MW19CS051)");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Under the Guidance of");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Ms.Yashaswini Jogi");
		glColor3f(1.0, 0.0, 0.0);
